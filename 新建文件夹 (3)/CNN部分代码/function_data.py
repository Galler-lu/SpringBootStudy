...
def feature_extraction(sample_data):
    ...
    #         fpeak, xpeak, psd_max, fenergy, apEn, sampEn, fuzzyEn]
...
def feature_extraction_gsr(sample_data):
    ...
    # return [peak, d2mean, d1std, d1peak, d1absmean, d2absmean, x2mean, x2iqr, fpeak, x2iqr, fpeak]
    # return [peak_to_peak, std, mean, energy, iqr, zeronum, cv, L, APR, peak,
    #             d1mean, d2mean, d1iqr, d2iqr, d1std, d2std, d1peak, d2peak, d1absmean, d2absmean, d1total_var, d2total_var,
    #             x2mean, x2peak, x2std, x2iqr]
    # return [peak_to_peak, std, L, peak, d2mean, d1std, d1peak, d1absmean, d1total_var, d2total_var, x2mean, x2peak,
    #         x2std, x2iqr, fpeak]
    # return [energy, cv, peak, d2mean, d1std, d1peak, d1absmean, d2absmean, d1total_var, fpeak, fpeak]  # 11个特征
    # return [peak_to_peak, std, mean, energy, iqr, cv, L, APR, peak,
    #         d1mean, d2mean, d1iqr, d2iqr, d1std, d2std, d1peak, d2peak, d1absmean, d2absmean,
    #         x2mean, x2peak, x2std, x2iqr, fpeak, x2iqr, fpeak]
    # return [mean, energy, iqr, cv, APR, peak, d2iqr, d2peak, d2absmean, d1total_var, x2mean, x2iqr, x2iqr]
    # return [energy, L, x2mean]
...
def feature_extraction_hrt(sample_data):
    ...
    # return [peak_to_peak, std, cv, L,
    #         d1mean,  d1iqr, d2iqr, d2std, d1peak, d2peak, d1absmean, d2absmean,
    #         x2mean,  x2std, x2iqr, fpeak, psd_max, fenergy]
    # return [std, energy, iqr, cv, peak, d2mean, d1iqr, d1std, d2std, d1absmean, d2absmean, d1total_var, x2std,
    #         x2iqr, ]  # 共14个
    # return [peak_to_peak, L, APR, peak, d2mean, d2std, d1total_var, d2total_var, x2peak]#共10个特征
    # return [peak_to_peak, std, iqr, cv, L, peak, d1mean, d1iqr, d2std, d1peak, d2peak, x2peak, x2std, x2iqr, fenergy]
